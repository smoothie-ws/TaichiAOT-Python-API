...
class TiMemoryAllocateInfo(Structure):
    ...
    _fields_ = [
        ...
        ("export_sharing", TiBool),  # True if the memory allocation needs to be exported to other backends (e.g.,
        # from Vulkan to CUDA).
        ("usage", c_uint32)  # All possible usage of this memory allocation. In most cases,
